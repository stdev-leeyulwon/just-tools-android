...
public class MainActivity extends Activity {
	...
	public String[] baseNames = {
			...
			"Quadragintimal",
			// 41 42 43 44 45
			"Unquadragintimal", "Duoquadragintimal",
			"Triquadragintimal",
			"Tetraquadragintimal",
			"Pentaquadragintimal",
			// 46 47 48 49 50
			"Hexaquadragintimal", "Septiquadragintimal", "Octoquadragintimal",
			"Novemquadragintimal",
			"Quinquagintimal",
			// 51 52 53 54 55
			"Unquinquagintimal", "Duoquinquagintimal", "Triquinquagintimal",
			"Tetraquinquagintimal", "Pentaquinquagintimal",
			// 56 57 58 59 60
			"Hexaquinquagintimal", "Septiquinquagintimal",
			"Octoquinquagintimal", "Novemquinquagintimal", "Sexagintimal",
			// 61 62
	...
	/**
	 * Returns base string for given int (base)
	 * @param i Base
	 * @return Base string
	 * @author Park SooHyun(Shift)
	 */
	public String outBase(int i) {
		if (i <= 10) {
			...
			return baseNames[i] + "\nBase" + i + ", 0~9, A~"
					+ Integer.toString(i - 1, i).toUpperCase();
		} else if (i == 37) {
			return baseNames[i] + "\nBase" + i
					+ ", 0~9, A~Z, a\n(Case sensitive)";
		} else {
			return baseNames[i] + "\nBase" + i + ", 0~9, A~Z, a~"
					+ Integer.toString(i - 27, i - 26).toLowerCase()
					+ "\n(Case sensitive)";
		}
	}

	/**
	 * Changes current input base. (+1)
	 * @param v Unused
	 * @author Park SooHyun(Shift)
	 */
	...
	/**
	 * Updates views when input/output base is <=36.
	 * @author Park SooHyun(Shift)
	 */
	public void update() {
		try {
			...
			convLimit.setText("Convert Limit: "
					+ toString32(Long.MAX_VALUE, iBase).toUpperCase());
			iUnparsed.addTextChangedListener(watcher);
		} catch (Exception e) {
			iUnparsed.removeTextChangedListener(watcher);
	...
	/**
	 * Updates view when input/output base x is 37 <= x <= 62.
	 * @author Park SooHyun(Shift)
	 */
	public void update62() {
		try {
			...
			convLimit.setText("Convert Limit: "
					+ toString62(Long.MAX_VALUE, iBase));
			iUnparsed.addTextChangedListener(watcher);
		} catch (Exception e) {
			iUnparsed.removeTextChangedListener(watcher);
			oParsed.setText("ERROR");
	...
	/**
	 * Parses base-specific string e to long. (base <= 36)
	 * @param e Base-specific string
	...
	/**
	 * Parses base-specific string e to long. (37 <= base <= 62)
	 * @param e Base-specific string
	 * @param base Input base
	 * @return Parsed string
	 * @author Park SooHyun(Shift)
	...
	/**
	 * Returns base-specific string for given base(<= 36) and long.
	 * @param l Decimal long
	 * @param i Output base
	 * @return Long converted to base i
	 * @author Park SooHyun(Shift)
	 */
	...
	/**
	 * Returns base-specific string for given (37 =<)base(<= 62) and long.
	 * @param l Decimal long
	 * @param i Output base
	 * @return Long converted to base i
	 * @author Park SooHyun(Shift)
	...
	/**
	 * Get int value of the character.
	 * @param c Character that holds number value.
	 * @return Number value of the given char
	 * @author Park SooHyun(Shift)
	 */
	...
	/**
	 * Get char of the int value.
	 * @param c Number value
	 * @return Char of the given number value
	 * @author Park SooHyun(Shift)
	 */
